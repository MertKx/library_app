        ...
        <div class="content-section">
            ...
            <div class="feature-grid">
                <div class="feature-item">
                    <h3 class="feature-title">Browse Catalog</h3>
                    <p class="feature-description">Explore our extensive collection of books, journals, and digital resources</p>
                </div>
                <div class="feature-item">
                    <h3 class="feature-title">Member Portal</h3>
                    <p class="feature-description">Access your account, view borrowed items, and manage reservations</p>
                </div>
                <div class="feature-item">
                    <h3 class="feature-title">Admin Dashboard</h3>
                    <p class="feature-description">Comprehensive tools for librarians and administrators</p>
                </div>
            </div>

            <div class="cta-section">
                <a href="/dashboard" class="btn-cta">Access Dashboard</a>
            </div>
        </div>
    </main>
</div>
                <div class="bg-[#fff2f2] dark:bg-[#1D0002] relative lg:-ms-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-e-lg! aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">
                    ...
                    <svg class="w-[448px] max-w-none relative -mt-[4.9rem] -ms-8 lg:ms-0 lg:-mt-[6.6rem] dark:hidden" viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g style="mix-blend-mode: darken" class="transition-all delay-300 translate-y-0 opacity-100 duration-750 starting:opacity-0 starting:translate-y-4">
